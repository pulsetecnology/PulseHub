...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userType === "fornecedor" && !companyName) {
        setError("Nome da empresa é obrigatório para fornecedores");
        setIsLoading(false);
        return;
      }

      // Simulação de registro - em uma implementação real, isso seria uma chamada de API
      setTimeout(() => {
        // Registro simulado
        login(userType, { name, email });
      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/20">
          ...
          <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
            Cadastre-se como {userType === "fornecedor" ? "Fornecedor" : "Revendedor"}
          </p>
