...
const mockOrders = [
  { id: "#1234", supplier: "Fornecedor Teste", date: "2024-07-18", total: "R$ 1.200,00", status: "Entregue" },
  { id: "#1235", supplier: "Fornecedor Teste", date: "2024-07-17", total: "R$ 850,00", status: "Enviado" },
  { id: "#1236", supplier: "Fornecedor Calçados", date: "2024-07-16", total: "R$ 2.340,00", status: "Pendente" },
  { id: "#1237", supplier: "Fornecedor Moda Feminina", date: "2024-07-15", total: "R$ 500,00", status: "Cancelado" },
];
              ...
              {filteredOrders.map(order => (
                <tr key={order.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <Link href={`/reseller/orders/${order.id}`} className="text-primary hover:underline">Ver Detalhes</Link>
                  </td>
                </tr>
              ))}
            </tbody>
